...
- **2026-09-03**: límites por palabras (plan: `palabras_mes`, `palabras_max_doc`; topes absolutos 40.000 palabras / 200.000 caracteres / 20 MB), reserva y devolución de cuota, ventanas de ~3.000 palabras en etapas 2 y 4, tokens/costo reales del proveedor, `GET /documents/{id}/estimate`, panel `/admin/consumo` (+CSV). Planes: free 5/15.000/5.000 · Personal 20/60.000/6.000 · Despacho (code `pro`) 100/400.000/15.000 · Empresa (code `despacho`) 300/1.500.000/30.000. Sitio público operativo en https://mvp.clauscheck.info (túnel). Correo: SPF y DKIM ya existen; falta DMARC; mail-tester 10/10. Pendiente usuario: Cloudflare Access en /docs-ui y /admin, DMARC, contraseña + MFA del superadmin.
